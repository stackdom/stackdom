...
const LOOPS = {
  ...
  name: 'Loops',
  short_description: 'Send marketing and product email from one platform',
  category: 'Email',
...
const CAL_COM = {
  ...
  name: 'Cal.com',
  short_description: 'Open-source scheduling tool for individuals and teams',
  category: 'Scheduling',
...
const CALENDLY = {
  ...
  name: 'Calendly',
  short_description: 'Let customers book meetings with you automatically',
  category: 'Scheduling',
