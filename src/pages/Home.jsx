...
export default function Home() {
  ...
  useEffect(() => {
    base44.entities.Tool.list('-created_date', 8).then(setTools);
    base44.entities.Stack.filter({ featured: true }, '-created_date', 3).then(setStacks);
    base44.entities.Playbook.filter({ featured: true }, '-created_date', 4).then(setPlaybooks);
  }, []);
