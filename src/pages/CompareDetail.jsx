...
export default function CompareDetail() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      base44.entities.Tool.filter({ slug: slugA }, '-created_date', 1),
      base44.entities.Tool.filter({ slug: slugB }, '-created_date', 1),
  ...
  if (!toolA || !toolB) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-20 text-center">
        ...
        <Link to="/compare"><Button variant="outline">Back to comparisons</Button></Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
      <Link to="/compare" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-8 transition-colors">
